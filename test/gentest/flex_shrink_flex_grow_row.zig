...
test "flex_shrink_flex_grow_row" {
    ...
    node_1_style.size.width = S.Dimension{ .Points = 500.0 };
    ...
    node_2_style.flex_grow = 0.0;
    node_2_style.flex_shrink = 1.0;
    node_2_style.size.width = S.Dimension{ .Points = 500.0 };
    node_2_style.size.height = S.Dimension{ .Points = 100.0 };
    ...
    try std.testing.expect(node_1_layout.size.width == 250.0);
    ...
    try std.testing.expect(node_2_layout.size.width == 250.0);
