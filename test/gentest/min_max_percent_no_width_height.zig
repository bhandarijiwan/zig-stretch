...
test "min_max_percent_no_width_height" {
    ...
    node_1_style.min_size.width = S.Dimension{ .Percent = 0.1 };
    node_1_style.min_size.height = S.Dimension{ .Percent = 0.1 };
    node_1_style.max_size.width = S.Dimension{ .Percent = 0.1 };
    node_1_style.max_size.height = S.Dimension{ .Percent = 0.1 };
