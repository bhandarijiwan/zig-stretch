...
test "display_none_with_child" {
    ...
    node_2_1_style.flex_grow = 1.0;
    node_2_1_style.flex_shrink = 1.0;
    node_2_1_style.flex_basis = S.Dimension{ .Percent = 0.0 };
    ...
    node_3_style.flex_shrink = 1.0;
    node_3_style.flex_basis = S.Dimension{ .Percent = 0.0 };
    ...
    try std.testing.expect(node_2_1_layout.size.width == 0.0);
    try std.testing.expect(node_2_1_layout.size.height == 0.0);
    ...
    try std.testing.expect(node_3_layout.location.x == 50.0);
