...
test "justify_content_column_space_evenly" {
    ...
    try std.testing.expect(node_1_layout.location.y == 18.0);
    ...
    try std.testing.expect(node_2_layout.location.y == 45.0);
    ...
    try std.testing.expect(node_3_layout.location.y == 73.0);
}
