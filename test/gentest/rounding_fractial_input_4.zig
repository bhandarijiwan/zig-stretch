...
test "rounding_fractial_input_4" {
    ...
    try std.testing.expect(node_1_layout.size.height == 64.0);
    ...
    try std.testing.expect(node_2_layout.size.height == 24.0);
    try std.testing.expect(node_2_layout.location.x == 0.0);
    try std.testing.expect(node_2_layout.location.y == 64.0);
