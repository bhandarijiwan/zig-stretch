...
test "justify_content_overflow_min_max" {
    ...
    node_style.min_size.height = S.Dimension{ .Points = 100.0 };
    node_style.max_size.height = S.Dimension{ .Points = 110.0 };
    ...
    try std.testing.expect(node_layout.size.height == 110.0);
    ...
    try std.testing.expect(node_3_layout.location.y == 80.0);
}
