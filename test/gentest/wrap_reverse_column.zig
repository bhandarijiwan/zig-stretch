...
test "wrap_reverse_column" {
    ...
    node_1_style.size.height = S.Dimension{ .Points = 31.0 };
    ...
    node_2_style.size.height = S.Dimension{ .Points = 32.0 };
    ...
    node_3_style.size.height = S.Dimension{ .Points = 33.0 };
    ...
    node_4_style.size.height = S.Dimension{ .Points = 34.0 };
    ...
    try std.testing.expect(node_1_layout.size.height == 31.0);
    try std.testing.expect(node_1_layout.location.x == 70.0);
    ...
    try std.testing.expect(node_2_layout.size.height == 32.0);
    try std.testing.expect(node_2_layout.location.x == 70.0);
    try std.testing.expect(node_2_layout.location.y == 31.0);

    const node_3_layout = try stretch.layout(node_3);
    try std.testing.expect(node_3_layout.size.width == 30.0);
    try std.testing.expect(node_3_layout.size.height == 33.0);
    try std.testing.expect(node_3_layout.location.x == 70.0);
    try std.testing.expect(node_3_layout.location.y == 63.0);

    const node_4_layout = try stretch.layout(node_4);
    try std.testing.expect(node_4_layout.size.width == 30.0);
    try std.testing.expect(node_4_layout.size.height == 34.0);
    try std.testing.expect(node_4_layout.location.x == 20.0);
