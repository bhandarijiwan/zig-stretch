...
test "percentage_flex_basis_main_max_height" {
    ...
    node_1_style.max_size.height = S.Dimension{ .Percent = 0.6 };
    ...
    node_2_style.max_size.height = S.Dimension{ .Percent = 0.2 };
    ...
    try std.testing.expect(node_1_layout.size.height == 240.0);
    ...
    try std.testing.expect(node_2_layout.size.width == 148.0);
    try std.testing.expect(node_2_layout.size.height == 80.0);
    try std.testing.expect(node_2_layout.location.x == 52.0);
