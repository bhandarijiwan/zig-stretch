...
test "wrap_reverse_column_fixed_size" {
    ...
    try std.testing.expect(node_1_layout.location.x == 135.0);
    ...
    try std.testing.expect(node_2_layout.location.x == 135.0);
    ...
    try std.testing.expect(node_3_layout.location.x == 135.0);
    ...
    try std.testing.expect(node_4_layout.location.x == 135.0);
    try std.testing.expect(node_4_layout.location.y == 60.0);
    ...
    try std.testing.expect(node_5_layout.location.x == 35.0);
