...
test "wrap_row" {
    ...
    node_1_style.size.width = S.Dimension{ .Points = 31.0 };
    node_1_style.size.height = S.Dimension{ .Points = 30.0 };

    const node_1 = try stretch.new_node(node_1_style, &[_]S.Node{});

    var node_2_style = S.Style.default();
    node_2_style.size.width = S.Dimension{ .Points = 32.0 };
    node_2_style.size.height = S.Dimension{ .Points = 30.0 };

    const node_2 = try stretch.new_node(node_2_style, &[_]S.Node{});

    var node_3_style = S.Style.default();
    node_3_style.size.width = S.Dimension{ .Points = 33.0 };
    ...
    node_4_style.size.width = S.Dimension{ .Points = 34.0 };
    node_4_style.size.height = S.Dimension{ .Points = 30.0 };
    ...
    try std.testing.expect(node_layout.size.height == 60.0);
    ...
    try std.testing.expect(node_1_layout.size.width == 31.0);
    try std.testing.expect(node_1_layout.size.height == 30.0);
    ...
    try std.testing.expect(node_2_layout.size.width == 32.0);
    try std.testing.expect(node_2_layout.size.height == 30.0);
    try std.testing.expect(node_2_layout.location.x == 31.0);
    try std.testing.expect(node_2_layout.location.y == 0.0);

    const node_3_layout = try stretch.layout(node_3);
    try std.testing.expect(node_3_layout.size.width == 33.0);
    try std.testing.expect(node_3_layout.size.height == 30.0);
    try std.testing.expect(node_3_layout.location.x == 63.0);
    try std.testing.expect(node_3_layout.location.y == 0.0);

    const node_4_layout = try stretch.layout(node_4);
    try std.testing.expect(node_4_layout.size.width == 34.0);
    try std.testing.expect(node_4_layout.size.height == 30.0);
