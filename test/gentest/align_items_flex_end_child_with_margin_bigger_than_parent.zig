...
test "align_items_flex_end_child_with_margin_bigger_than_parent" {
    ...
    node_1_1_style.size.width = S.Dimension{ .Points = 50.0 };
    node_1_1_style.size.height = S.Dimension{ .Points = 50.0 };
    node_1_1_style.margin.start = S.Dimension{ .Points = 10.0 };
    node_1_1_style.margin.end = S.Dimension{ .Points = 10.0 };

    const node_1_1 = try stretch.new_node(node_1_1_style, &[_]S.Node{});

    var node_1_style = S.Style.default();
    node_1_style.align_items = S.AlignItems.FlexEnd;
    ...
    try std.testing.expect(node_1_1_layout.size.width == 50.0);
    try std.testing.expect(node_1_1_layout.size.height == 50.0);
    try std.testing.expect(node_1_1_layout.location.x == 10.0);
