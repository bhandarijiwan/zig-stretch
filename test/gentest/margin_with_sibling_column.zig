...
test "margin_with_sibling_column" {
    ...
    try std.testing.expect(node_1_layout.size.height == 45.0);
    ...
    try std.testing.expect(node_2_layout.size.height == 45.0);
    try std.testing.expect(node_2_layout.location.x == 0.0);
    try std.testing.expect(node_2_layout.location.y == 55.0);
}
