...
test "flex_direction_column_reverse" {
    ...
    node_style.flex_direction = S.FlexDirection.ColumnReverse;
    ...
    try std.testing.expect(node_1_layout.location.y == 90.0);
    ...
    try std.testing.expect(node_3_layout.location.y == 70.0);
}
