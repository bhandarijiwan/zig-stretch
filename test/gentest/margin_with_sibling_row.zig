...
test "margin_with_sibling_row" {
    ...
    try std.testing.expect(node_1_layout.size.width == 45.0);
    ...
    try std.testing.expect(node_2_layout.size.width == 45.0);
    try std.testing.expect(node_2_layout.size.height == 100.0);
    try std.testing.expect(node_2_layout.location.x == 55.0);
