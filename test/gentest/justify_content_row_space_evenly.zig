...
test "justify_content_row_space_evenly" {
    ...
    node_style.justify_content = S.JustifyContent.SpaceEvenly;
    ...
    try std.testing.expect(node_1_layout.location.x == 25.0);
    ...
    try std.testing.expect(node_3_layout.size.width == 0.0);
