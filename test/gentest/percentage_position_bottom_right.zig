...
test "percentage_position_bottom_right" {
    ...
    node_1_style.size.width = S.Dimension{ .Percent = 0.55 };
    node_1_style.size.height = S.Dimension{ .Percent = 0.15 };
    node_1_style.position.end = S.Dimension{ .Percent = 0.2 };
    node_1_style.position.bottom = S.Dimension{ .Percent = 0.1 };
    ...
    try std.testing.expect(node_1_layout.size.width == 275.0);
    try std.testing.expect(node_1_layout.size.height == 75.0);
    try std.testing.expect(node_1_layout.location.x == -100.0);
    try std.testing.expect(node_1_layout.location.y == -50.0);
}
