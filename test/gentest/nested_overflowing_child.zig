...
test "nested_overflowing_child" {
    ...
    node_1_1_style.size.width = S.Dimension{ .Points = 200.0 };
    node_1_1_style.size.height = S.Dimension{ .Points = 200.0 };
    ...
    try std.testing.expect(node_1_1_layout.size.width == 200.0);
