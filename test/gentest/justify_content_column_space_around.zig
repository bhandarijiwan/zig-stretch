...
test "justify_content_column_space_around" {
    ...
    node_style.justify_content = S.JustifyContent.SpaceAround;
    ...
    try std.testing.expect(node_1_layout.location.y == 12.0);
    ...
    try std.testing.expect(node_3_layout.location.y == 78.0);
}
