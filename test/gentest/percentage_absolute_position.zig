...
test "percentage_absolute_position" {
    ...
    node_1_style.position.start = S.Dimension{ .Percent = 0.3 };
    node_1_style.position.top = S.Dimension{ .Percent = 0.1 };
    ...
    try std.testing.expect(node_1_layout.location.x == 60.0);
