...
test "flex_grow_root_minimized" {
    ...
    try std.testing.expect(node_1_layout.size.height == 300.0);
    ...
    try std.testing.expect(node_1_1_layout.size.height == 200.0);
    ...
    try std.testing.expect(node_1_2_layout.location.y == 200.0);
}
