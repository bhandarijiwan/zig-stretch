...
test "flex_basis_smaller_then_content_with_flex_grow_small_size" {
    ...
    node_style.size.width = S.Dimension{ .Points = 10.0 };
    ...
    try std.testing.expect(node_layout.size.width == 10.0);
