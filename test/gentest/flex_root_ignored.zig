...
test "flex_root_ignored" {
    ...
    node_1_style.flex_basis = S.Dimension{ .Points = 200.0 };
    ...
    node_style.max_size.height = S.Dimension{ .Points = 500.0 };
    ...
    try std.testing.expect(node_layout.size.height == 300.0);
