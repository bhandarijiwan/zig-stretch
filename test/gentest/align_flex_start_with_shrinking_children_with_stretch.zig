...
test "align_flex_start_with_shrinking_children_with_stretch" {
    ...
    node_1_style.align_items = S.AlignItems.FlexStart;
    ...
    try std.testing.expect(node_1_1_layout.size.height == 0.0);
    ...
    try std.testing.expect(node_1_1_1_layout.size.height == 0.0);
