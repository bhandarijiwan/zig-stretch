...
test "flex_grow_less_than_factor_one" {
    ...
    try std.testing.expect(node_1_layout.size.width == 132.0);
    ...
    try std.testing.expect(node_2_layout.size.width == 92.0);
    try std.testing.expect(node_2_layout.size.height == 200.0);
    try std.testing.expect(node_2_layout.location.x == 132.0);
    try std.testing.expect(node_2_layout.location.y == 0.0);

    const node_3_layout = try stretch.layout(node_3);
    try std.testing.expect(node_3_layout.size.width == 184.0);
    try std.testing.expect(node_3_layout.size.height == 200.0);
    try std.testing.expect(node_3_layout.location.x == 224.0);
