...
test "percentage_flex_basis_cross_min_height" {
    ...
    node_1_style.min_size.height = S.Dimension{ .Percent = 0.6 };

    const node_1 = try stretch.new_node(node_1_style, &[_]S.Node{});

    var node_2_style = S.Style.default();
    node_2_style.flex_grow = 2.0;
    node_2_style.min_size.height = S.Dimension{ .Percent = 0.1 };
    ...
    try std.testing.expect(node_2_layout.size.height == 160.0);
