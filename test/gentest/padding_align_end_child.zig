...
test "padding_align_end_child" {
    ...
    node_1_style.padding.start = S.Dimension{ .Points = 20.0 };
    node_1_style.padding.end = S.Dimension{ .Points = 20.0 };
    node_1_style.padding.top = S.Dimension{ .Points = 20.0 };
    node_1_style.padding.bottom = S.Dimension{ .Points = 20.0 };
    ...
    try std.testing.expect(node_1_layout.location.x == 100.0);
