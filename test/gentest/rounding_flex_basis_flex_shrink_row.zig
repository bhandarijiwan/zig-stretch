...
test "rounding_flex_basis_flex_shrink_row" {
    ...
    try std.testing.expect(node_layout.size.width == 101.0);
    ...
    try std.testing.expect(node_1_layout.size.width == 67.0);
    ...
    try std.testing.expect(node_2_layout.size.width == 17.0);
    try std.testing.expect(node_2_layout.size.height == 100.0);
    try std.testing.expect(node_2_layout.location.x == 67.0);
    try std.testing.expect(node_2_layout.location.y == 0.0);

    const node_3_layout = try stretch.layout(node_3);
    try std.testing.expect(node_3_layout.size.width == 17.0);
    try std.testing.expect(node_3_layout.size.height == 100.0);
    try std.testing.expect(node_3_layout.location.x == 84.0);
