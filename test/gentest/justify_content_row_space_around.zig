...
test "justify_content_row_space_around" {
    ...
    try std.testing.expect(node_1_layout.location.x == 12.0);
    ...
    try std.testing.expect(node_2_layout.location.x == 45.0);
    ...
    try std.testing.expect(node_3_layout.location.x == 78.0);
