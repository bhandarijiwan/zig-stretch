...
test "flex_basis_overrides_main_size" {
    ...
    try std.testing.expect(node_2_layout.location.x == 60.0);
    try std.testing.expect(node_2_layout.location.y == 0.0);

    const node_3_layout = try stretch.layout(node_3);
    try std.testing.expect(node_3_layout.size.width == 20.0);
    try std.testing.expect(node_3_layout.size.height == 100.0);
    try std.testing.expect(node_3_layout.location.x == 80.0);
