...
test "wrap_nodes_with_content_sizing_overflowing_margin" {
    ...
    node_1_2_style.margin.end = S.Dimension{ .Points = 10.0 };
    ...
    node_1_style.size.width = S.Dimension{ .Points = 85.0 };
    ...
    try std.testing.expect(node_1_layout.size.width == 85.0);
    ...
    try std.testing.expect(node_1_2_layout.location.y == 40.0);
