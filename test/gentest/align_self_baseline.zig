...
test "align_self_baseline" {
    ...
    node_1_style.align_self = S.AlignSelf.Baseline;
    ...
    node_2_1_style.size.width = S.Dimension{ .Points = 50.0 };
    node_2_1_style.size.height = S.Dimension{ .Points = 10.0 };

    const node_2_1 = try stretch.new_node(node_2_1_style, &[_]S.Node{});

    var node_2_style = S.Style.default();
    node_2_style.align_self = S.AlignSelf.Baseline;
    ...
    try std.testing.expect(node_2_1_layout.size.width == 50.0);
    try std.testing.expect(node_2_1_layout.size.height == 10.0);
