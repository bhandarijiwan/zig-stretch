...
test "relative_position_should_not_nudge_siblings" {
    ...
    node_1_style.position.top = S.Dimension{ .Points = 15.0 };
    ...
    node_2_style.position.top = S.Dimension{ .Points = 15.0 };
    ...
    try std.testing.expect(node_1_layout.location.y == 15.0);
    ...
    try std.testing.expect(node_2_layout.location.y == 25.0);
}
