...
test "margin_auto_mutiple_children_column" {
    ...
    node_2_style.margin.top = S.Dimension.Auto;
    ...
    try std.testing.expect(node_1_layout.location.x == 75.0);
    try std.testing.expect(node_1_layout.location.y == 25.0);
    ...
    try std.testing.expect(node_2_layout.location.x == 75.0);
    try std.testing.expect(node_2_layout.location.y == 100.0);
    ...
    try std.testing.expect(node_3_layout.location.x == 75.0);
    try std.testing.expect(node_3_layout.location.y == 150.0);
}
