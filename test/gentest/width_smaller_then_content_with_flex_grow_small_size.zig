...
test "width_smaller_then_content_with_flex_grow_small_size" {
    ...
    node_1_style.size.width = S.Dimension{ .Points = 0.0 };
    ...
    try std.testing.expect(node_1_layout.size.width == 5.0);
    ...
    try std.testing.expect(node_2_layout.size.width == 5.0);
    try std.testing.expect(node_2_layout.size.height == 100.0);
    try std.testing.expect(node_2_layout.location.x == 5.0);
