...
test "percentage_padding_should_calculate_based_only_on_width" {
    ...
    node_1_style.padding.start = S.Dimension{ .Percent = 0.1 };
    node_1_style.padding.end = S.Dimension{ .Percent = 0.1 };
    node_1_style.padding.top = S.Dimension{ .Percent = 0.1 };
    node_1_style.padding.bottom = S.Dimension{ .Percent = 0.1 };
    ...
    try std.testing.expect(node_1_1_layout.location.x == 20.0);
    try std.testing.expect(node_1_1_layout.location.y == 20.0);
}
