...
test "percent_within_flex_grow" {
    ...
    node_2_1_style.size.width = S.Dimension{ .Percent = 1.0 };
    ...
    node_style.size.width = S.Dimension{ .Points = 350.0 };
    ...
    try std.testing.expect(node_layout.size.width == 350.0);
    ...
    try std.testing.expect(node_2_layout.size.width == 150.0);
    ...
    try std.testing.expect(node_2_1_layout.size.width == 150.0);
    ...
    try std.testing.expect(node_3_layout.location.x == 250.0);
