...
test "flex_grow_within_constrained_max_row" {
    ...
    node_1_1_style.flex_basis = S.Dimension{ .Points = 100.0 };

    const node_1_1 = try stretch.new_node(node_1_1_style, &[_]S.Node{});

    var node_1_2_style = S.Style.default();
    node_1_2_style.size.width = S.Dimension{ .Points = 50.0 };
    ...
    try std.testing.expect(node_1_1_layout.size.width == 67.0);
    ...
    try std.testing.expect(node_1_2_layout.size.width == 33.0);
    try std.testing.expect(node_1_2_layout.size.height == 100.0);
    try std.testing.expect(node_1_2_layout.location.x == 67.0);
