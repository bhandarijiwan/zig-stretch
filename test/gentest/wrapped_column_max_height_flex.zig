...
test "wrapped_column_max_height_flex" {
    ...
    node_1_style.flex_basis = S.Dimension{ .Percent = 0.0 };
    ...
    node_2_style.flex_shrink = 1.0;
    node_2_style.flex_basis = S.Dimension{ .Percent = 0.0 };
    ...
    try std.testing.expect(node_1_layout.location.x == 300.0);
    ...
    try std.testing.expect(node_2_layout.size.height == 180.0);
    try std.testing.expect(node_2_layout.location.x == 250.0);
    try std.testing.expect(node_2_layout.location.y == 200.0);
    ...
    try std.testing.expect(node_3_layout.location.x == 300.0);
    try std.testing.expect(node_3_layout.location.y == 400.0);
}
