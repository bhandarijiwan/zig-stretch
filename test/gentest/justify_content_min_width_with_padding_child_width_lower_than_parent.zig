...
test "justify_content_min_width_with_padding_child_width_lower_than_parent" {
    ...
    node_1_1_1_style.size.width = S.Dimension{ .Points = 199.0 };
    ...
    node_style.size.width = S.Dimension{ .Points = 1080.0 };
    ...
    try std.testing.expect(node_layout.size.width == 1080.0);
    ...
    try std.testing.expect(node_1_layout.size.width == 1080.0);
    ...
    try std.testing.expect(node_1_1_layout.size.width == 400.0);
    ...
    try std.testing.expect(node_1_1_1_layout.size.width == 199.0);
    try std.testing.expect(node_1_1_1_layout.size.height == 100.0);
    try std.testing.expect(node_1_1_1_layout.location.x == 101.0);
