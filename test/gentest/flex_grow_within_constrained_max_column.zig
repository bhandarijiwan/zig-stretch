...
test "flex_grow_within_constrained_max_column" {
    ...
    node_style.max_size.height = S.Dimension{ .Points = 100.0 };
    ...
    try std.testing.expect(node_1_layout.size.height == 67.0);
    ...
    try std.testing.expect(node_2_layout.size.height == 33.0);
    try std.testing.expect(node_2_layout.location.x == 0.0);
    try std.testing.expect(node_2_layout.location.y == 67.0);
}
