...
test "percentage_flex_basis" {
    ...
    try std.testing.expect(node_1_layout.size.width == 125.0);
    ...
    try std.testing.expect(node_2_layout.size.width == 75.0);
    try std.testing.expect(node_2_layout.size.height == 200.0);
    try std.testing.expect(node_2_layout.location.x == 125.0);
