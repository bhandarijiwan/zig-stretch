...
test "justify_content_row_max_width_and_margin" {
    ...
    node_1_style.margin.start = S.Dimension{ .Points = 100.0 };
    ...
    node_style.max_size.width = S.Dimension{ .Points = 80.0 };
    ...
    try std.testing.expect(node_layout.size.width == 80.0);
    ...
    try std.testing.expect(node_1_layout.location.x == 90.0);
