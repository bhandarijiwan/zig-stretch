...
test "percentage_flex_basis_cross" {
    ...
    try std.testing.expect(node_1_layout.size.height == 250.0);
    ...
    try std.testing.expect(node_2_layout.size.height == 150.0);
