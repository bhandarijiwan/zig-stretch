...
test "percent_absolute_position" {
    ...
    node_1_2_style.size.width = S.Dimension{ .Percent = 1.0 };
    ...
    node_1_style.size.width = S.Dimension{ .Percent = 1.0 };
    node_1_style.size.height = S.Dimension{ .Points = 50.0 };
    node_1_style.position.start = S.Dimension{ .Percent = 0.5 };
    ...
    node_style.size.width = S.Dimension{ .Points = 60.0 };
    ...
    try std.testing.expect(node_layout.size.width == 60.0);
    ...
    try std.testing.expect(node_1_layout.location.x == 30.0);
    try std.testing.expect(node_1_layout.location.y == 0.0);

    const node_1_1_layout = try stretch.layout(node_1_1);
    try std.testing.expect(node_1_1_layout.size.width == 30.0);
    ...
    try std.testing.expect(node_1_2_layout.size.width == 30.0);
    try std.testing.expect(node_1_2_layout.size.height == 50.0);
    try std.testing.expect(node_1_2_layout.location.x == 30.0);
    try std.testing.expect(node_1_2_layout.location.y == 0.0);
}
